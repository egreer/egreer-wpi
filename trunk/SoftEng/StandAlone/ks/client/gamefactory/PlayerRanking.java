...
public class PlayerRanking extends Canvas {
...
public PlayerRanking() {
	...
	//updatePlayerInfo("Jenny", 97, 3);
	//updatePlayerInfo("Mike", 150, 2);
	//updatePlayerInfo("John", 14, 0);
}
/**
...
public void paint(java.awt.Graphics g) {
	...
	for (int i = 0; i< numPlayers; i++) {
		...
		g.drawString (players[i] + " (" + points[i] + ")", 
