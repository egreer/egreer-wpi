...
public class Klondike extends Solitaire implements SolvableSolitaire {
	...
	/** View for the number of cards left in the eck. */
	...
	protected BuildablePile fromColumnView = null;

	/** Move Types. */
	public static final int dealCard              = 1;
	public static final int moveCardToFoundation  = 2;
	public static final int moveWasteToFoundation = 3;
	public static final int moveStack             = 4;
	public static final int flipCard              = 5;
/**
