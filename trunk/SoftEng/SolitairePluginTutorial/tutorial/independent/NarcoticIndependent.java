...
import tutorial.vfinal.NarcoticDeckController;
import tutorial.vfinal.NarcoticPileController;
 ...
 */
public class NarcoticIndependent extends Solitaire {
...
//	}
	...
	private void initializeController() {
		...
		new ResetDeckController (new DealFourController(this, new SolitaireReleasedAdapter(this))));
	...
	public static void main (String []args) {
		...
		GameWindow gw = Main.generateWindow(new NarcoticIndependent(), 117);
		gw.setVisible(true);
	}
}
