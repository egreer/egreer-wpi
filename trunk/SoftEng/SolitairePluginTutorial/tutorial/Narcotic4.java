...
import tutorial.v4.NarcoticDeckController;
import tutorial.v4.NarcoticPileController;
 ...
 */
public class Narcotic4 extends Solitaire {
	...
	public static void main (String []args) {
		...
		GameWindow gw = Main.generateWindow(new Narcotic4(), 117);
		gw.setVisible(true);
	}
}
