...
public class IUser {
	...
	**/
	 ...
	 * @param newPassword String representing the new value for the password to be stored
	...
	**/
	...
	/**
	 * Function sets the number of the days the user is blocked for
	 * @param daysBlocked Int representing the number of days from the current date that the user is blocked until
	 *	-1 => Blocked Indefinitely
	 *	0 => Unblocked Immediately
	 * @return boolean representing if set of the block was successful (true), false otherwise
	**/
	public boolean setNumberOfDaysBlocked(int daysBlocked){
		return false;
	}
