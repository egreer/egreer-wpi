...
/**
 * Represents moving of a card from a reserve column to one of the left foundation piles. 
 * 
 * @author Eric Greer
 */

public class MoveCardLeftMove extends ks.common.model.Move{
	 ...
	 */
	public MoveCardLeftMove (Column from, Card movingCard, Pile to) {
		super();
	...
	public boolean valid(Solitaire currentGame){
		...
		//Makes sure the suits are the same, also make sure the moving card is directly greater then the foundation
