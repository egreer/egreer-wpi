...
public class UniqTest extends TestCase{
	...
	public UniqTest(IOutput component, UniqTester tester, String testName) throws InvalidClassException {
		super(testName);
		if(component instanceof Uniq && tester != null){
