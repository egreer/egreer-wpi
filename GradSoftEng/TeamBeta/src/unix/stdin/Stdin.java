...
/**
 * Represents stdin that initiates output. If customized with a "File" string,
 * then input is retrieved from there
 */
...
public class Stdin implements ICustomizableComponent, Runnable {
	...
	public void customize(Properties props) throws FileNotFoundException {
