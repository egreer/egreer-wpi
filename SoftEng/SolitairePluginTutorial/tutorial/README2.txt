...
click, enter, exit) while MouseMotionListener handles (drag, move). The overall behavior of a controller is to respond to mouse events and 
attempt to make moves as directed by the player.

The use cases will be the key to everything, as we shall see. Here is one
from the Narcotic problem:

http://web.cs.wpi.edu/~heineman/html/teaching_/CS3733_D08/narcotic/narcotic.html
